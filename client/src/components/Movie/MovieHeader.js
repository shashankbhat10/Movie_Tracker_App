...
const MovieHeader = ({ details, poster, crew }) => {
  ...
  const producer = crew.filter((person) => person.job === "Executive Producer")[0];
        ...
        <Card.Body className='col-md-8 pt-4'>
          ...
          <div className='d-flex flex-row justify-content-between align-items-center pt-4'>
            {director !== undefined && (
              <div>
                <span className='d-flex flex-column align-items-center'>
                  <Link to={`/person/${director.id}`} style={{ textDecoration: "none", color: "#c3d1d9" }}>
            ...
            {screenplay !== undefined && (
              <div>
                <span className='d-flex flex-column align-items-center'>
                  <Link to={`/person/${screenplay.id}`} style={{ textDecoration: "none", color: "#c3d1d9" }}>
            ...
            {producer !== undefined && (
              <div>
                <span className='d-flex flex-column align-items-center'>
                  <Link to={`/person/${producer.id}`} style={{ textDecoration: "none", color: "#c3d1d9" }}>
