...
import {
  getInteractedDirectorData,
  getInteractedPeopleData,
...
const PeopleStats = ({ watched, stats, watchlist, customLists }) => {
  ...
  useEffect(() => {
    const peopleData = getInteractedPeopleData(
      stats,
      watched,
      watchlist,
      customLists
    ...
    const directorData = getInteractedDirectorData(
      stats,
      watched,
      watchlist,
      customLists
              ...
              return (
                ...
                >
                  ...
                  <Card.Body className="px-1 py-1 d-flex flex-column">
                    ...
                    <span
                      style={{ fontSize: '90%' }}
                      onClick={() => handleModalClick(actor)}
                    >
